...
class shortest_path(app_manager.RyuApp):
    ...
    #Initial handshake between switch and controller proactive entries are added to switch here
    ...
    def send_packet(self, dp, port, pkt):
        ...
        dp.send_msg(out)
    #In our case arp table is hardcoded so arprequest is resolved bycontroller
